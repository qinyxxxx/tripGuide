        ...
        <header style={{ position: 'sticky', top: '0', zIndex: '1000', backgroundColor: 'rgba(255, 255, 255)' }} className="sticky-top shadow py-2">
            <div className="container d-flex justify-content-between align-items-center">
                ...
                <div className="d-flex justify-content-center align-items-center">
                    <Link to="/home" className="btn text-dark btn-link text-decoration-none fs-8 mx-2">Home</Link>
                    <Link to="/my-posts" className="btn text-dark btn-link text-decoration-none fs-8 mx-2">My Posts</Link>
                </div>
                <div>
                    {user ? (
                        <>
                            <span className="me-3">Hi, {user.name}!</span>
                            <Link to="/profile" className="btn btn-outline-dark btn-sm me-2">Profile</Link>
                        </>
                    ) : (
